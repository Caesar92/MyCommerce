            ...
            <c:choose>
                <c:when test="${!empty productList}">
                    ...
                    <tr class="align-middle">
                        ...
                        <c:if test="${sessionScope.type == 'admin'}">
                            <td><a class="btn btn-secondary"
                                   href="/product-details?id=${product.id}">Details</a>
                            </td>
                            <td>
                                <form action="/auth/admin/remove-product" method="post">
                        ...
                        <c:if test="${sessionScope.type == 'user'}">
                            <td>
                                <form action="/auth/add-to-basket" method="post">
                                    <input hidden name="productId" value="${product.id}">
                    ...
                    <tr>
                        <td colspan="6"></td>
                        <td>
                            <a class="btn btn-secondary" href="/auth/admin/add-product">AJOUTER UN PRODUIT</a>
                        </td>
                    </tr>
                    </c:if>
                </c:when>
